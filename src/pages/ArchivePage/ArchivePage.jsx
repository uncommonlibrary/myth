    ...
    const fetchBooks = async () => {
      try {
        const response = await fetch(
          `${urlArchive}?fields%5B%5D=title&fields%5B%5D=author&filterByFormula=location%3D%22archive%22&sort%5B0%5D%5Bfield%5D=title&sort%5B0%5D%5Bdirection%5D=asc`,
          {
            method: "GET",
            headers: {
